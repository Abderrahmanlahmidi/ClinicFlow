...
export const CreateAppointement = lazy(
  () => import("../features/appointment/appointment")
);

export const MyAppointements = lazy(
  () => import("../features/appointment/myAppointments")
);

export const DoctorAvailabilities = lazy(
