    ...
    <div className="hidden lg:flex lg:w-1/2 bg-gray-900 items-center justify-center p-12 border-r border-gray-700">
      <div className="text-center max-w-2xl">
        ...
        <h1 className="text-3xl font-semibold text-white mb-3">
          Smarter <span className="text-gray-400">Healthcare</span> Management
        </h1>
        <p className="text-sm text-gray-300 mb-10 max-w-md mx-auto">
          Empowering clinics and professionals to streamline patient care,
          appointments, and operations with modern tools.
        </p>
