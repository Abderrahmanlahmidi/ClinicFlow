        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="space-y-8">
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 text-center">
              <div className="relative inline-block mb-4">
                ...
                >
                  <label
                    ...
                    className="bg-gray-900 text-white p-2 rounded-full cursor-pointer hover:bg-gray-700 transition-colors shadow-lg flex items-center justify-center"
                  >
              ...
              <p className="text-gray-500 text-sm">{`${userData.roleId.name}`}</p>
              ...
              {selectedImage && (
                <form onSubmit={handleSubmit(onSubmitImage)} className="mt-4">
                  <button
                    type="submit"
                    className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors duration-200 text-sm font-normal"
                  >
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-gray-900 font-medium">{`${GetYear(
                    userData.createdAt
                  )}`}</span>
                </div>
                <div className="flex justify-between items-center">
